var taskrouterDashboard = new Vue({
  ...
  data: {
    ...
    stats_get_url: "/api/dashboard/statistics",
    workers_get_url: "/api/dashboard/workers",
    workers: {},
    tasks_get_url: "/api/dashboard/tasks",
    taskList: [],
    taskWorker: {'1': '1'},
    taskCurrentSteps: {
      "canceled": 0,
...
$.getJSON('/api/dashboard/token' + '?identity=' + tokenUserid, function (tokenResponse) {
